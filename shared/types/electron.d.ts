...
// Copied here to fix <https://github.com/electron/electron/issues/10167>
...
declare namespace Electron {
  ...
  interface App extends EventEmitter {
     ...
     */
    on(event: "desktop-capturer-get-sources", listener: (event: Event, webContents: WebContents) => void): this
    once(event: "desktop-capturer-get-sources", listener: (event: Event, webContents: WebContents) => void): this
    addListener(event: "desktop-capturer-get-sources", listener: (event: Event, webContents: WebContents) => void): this
    removeListener(
     ...
     * returned. Custom value can be returned by setting event.returnValue.
     */
    on(event: "remote-get-current-web-contents", listener: (event: Event, webContents: WebContents) => void): this
    once(event: "remote-get-current-web-contents", listener: (event: Event, webContents: WebContents) => void): this
    addListener(
     ...
     * returned. Custom value can be returned by setting event.returnValue.
     */
    on(event: "remote-get-current-window", listener: (event: Event, webContents: WebContents) => void): this
    once(event: "remote-get-current-window", listener: (event: Event, webContents: WebContents) => void): this
    addListener(event: "remote-get-current-window", listener: (event: Event, webContents: WebContents) => void): this
    removeListener(event: "remote-get-current-window", listener: (event: Event, webContents: WebContents) => void): this
    /**
     ...
     * returned. Custom value can be returned by setting event.returnValue.
     */
    on(event: "remote-get-global", listener: (event: Event, webContents: WebContents, globalName: string) => void): this
    once(
    ...
    on(
      ...
      listener: (event: Event, webContents: WebContents, guestWebContents: WebContents) => void
    ): this
    once(
      event: "remote-get-guest-web-contents",
      listener: (event: Event, webContents: WebContents, guestWebContents: WebContents) => void
     ...
     */
    on(event: "remote-require", listener: (event: Event, webContents: WebContents, moduleName: string) => void): this
    once(event: "remote-require", listener: (event: Event, webContents: WebContents, moduleName: string) => void): this
    addListener(
  ...
  class ClientRequest extends EventEmitter {
    ...
    on(
      event: "login",
      listener: (authInfo: AuthInfo, callback: (username: string, password: string) => void) => void
    ): this
    once(
      event: "login",
      listener: (authInfo: AuthInfo, callback: (username: string, password: string) => void) => void
    ...
    on(
      event: "redirect",
      listener: (statusCode: number, method: string, redirectUrl: string, responseHeaders: any) => void
    ): this
    once(
      event: "redirect",
      listener: (statusCode: number, method: string, redirectUrl: string, responseHeaders: any) => void
  ...
  interface Protocol extends EventEmitter {
    ...
    interceptHttpProtocol(
      scheme: string,
      handler: (request: InterceptHttpProtocolRequest, callback: (redirectRequest: RedirectRequest) => void) => void,
      completion?: (error: Error) => void
    ): void
    /**
  ...
  class Session extends EventEmitter {
    ...
    setCertificateVerifyProc(
      proc: (request: CertificateVerifyProcRequest, callback: (verificationResult: number) => void) => void
    ): void
    /**
  ...
  class WebContents extends EventEmitter {
    ...
    on(
      ...
      listener: (event: Event, isMainFrame: boolean, frameProcessId: number, frameRoutingId: number) => void
    ): this
    once(
      event: "did-frame-finish-load",
      listener: (event: Event, isMainFrame: boolean, frameProcessId: number, frameRoutingId: number) => void
     ...
     * ipcRenderer.send().
     */
    on(event: "ipc-message", listener: (event: Event, channel: string, ...args: any[]) => void): this
    once(event: "ipc-message", listener: (event: Event, channel: string, ...args: any[]) => void): this
    addListener(event: "ipc-message", listener: (event: Event, channel: string, ...args: any[]) => void): this
    removeListener(event: "ipc-message", listener: (event: Event, channel: string, ...args: any[]) => void): this
    /**
     * Emitted when the renderer process sends a synchronous message via
     * ipcRenderer.sendSync().
     */
    on(event: "ipc-message-sync", listener: (event: Event, channel: string, ...args: any[]) => void): this
    once(event: "ipc-message-sync", listener: (event: Event, channel: string, ...args: any[]) => void): this
    addListener(event: "ipc-message-sync", listener: (event: Event, channel: string, ...args: any[]) => void): this
    removeListener(event: "ipc-message-sync", listener: (event: Event, channel: string, ...args: any[]) => void): this
    /**
     ...
     */
    on(event: "remote-get-builtin", listener: (event: Event, moduleName: string) => void): this
    once(event: "remote-get-builtin", listener: (event: Event, moduleName: string) => void): this
    addListener(event: "remote-get-builtin", listener: (event: Event, moduleName: string) => void): this
    removeListener(event: "remote-get-builtin", listener: (event: Event, moduleName: string) => void): this
    /**
     ...
     * can be returned by setting event.returnValue.
     */
    on(event: "remote-get-global", listener: (event: Event, globalName: string) => void): this
    once(event: "remote-get-global", listener: (event: Event, globalName: string) => void): this
    addListener(event: "remote-get-global", listener: (event: Event, globalName: string) => void): this
    removeListener(event: "remote-get-global", listener: (event: Event, globalName: string) => void): this
    /**
     * Emitted when <webview>.getWebContents() is called in the renderer process.
     * Calling event.preventDefault() will prevent the object from being returned.
     * Custom value can be returned by setting event.returnValue.
     */
    on(event: "remote-get-guest-web-contents", listener: (event: Event, guestWebContents: WebContents) => void): this
    once(event: "remote-get-guest-web-contents", listener: (event: Event, guestWebContents: WebContents) => void): this
    addListener(
      event: "remote-get-guest-web-contents",
      listener: (event: Event, guestWebContents: WebContents) => void
    ): this
    removeListener(
      event: "remote-get-guest-web-contents",
      listener: (event: Event, guestWebContents: WebContents) => void
     ...
     * can be returned by setting event.returnValue.
     */
    on(event: "remote-require", listener: (event: Event, moduleName: string) => void): this
    once(event: "remote-require", listener: (event: Event, moduleName: string) => void): this
    addListener(event: "remote-require", listener: (event: Event, moduleName: string) => void): this
    removeListener(event: "remote-require", listener: (event: Event, moduleName: string) => void): this
    /**
     * Emitted when the unresponsive web page becomes responsive again.
     */
    on(event: "responsive", listener: Function): this
    ...
    on(
      ...
      listener: (event: Event, devices: BluetoothDevice[], callback: (deviceId: string) => void) => void
    ): this
    once(
      event: "select-bluetooth-device",
      listener: (event: Event, devices: BluetoothDevice[], callback: (deviceId: string) => void) => void
  ...
  class WebRequest extends EventEmitter {
    ...
    onBeforeRedirect(
      ...
      listener: ((details: OnBeforeRedirectDetails) => void) | (null)
    ): void
    /**
     ...
     */
    onBeforeRequest(
      listener: ((details: OnBeforeRequestDetails, callback: (response: Response) => void) => void) | (null)
    ): void
    /**
     * The listener will be called with listener(details, callback) when a request is
     * about to occur. The uploadData is an array of UploadData objects. The callback
    ...
    onBeforeSendHeaders(
      ...
      listener:
        | ((details: OnBeforeSendHeadersDetails, callback: (response: OnBeforeSendHeadersResponse) => void) => void)
        | (null)
    ): void
    /**
     * The listener will be called with listener(details, callback) before sending an
    ...
    onHeadersReceived(
      ...
      listener:
        | ((details: OnHeadersReceivedDetails, callback: (response: OnHeadersReceivedResponse) => void) => void)
        | (null)
    ): void
    /**
     * The listener will be called with listener(details, callback) when HTTP response
    ...
    onResponseStarted(
      ...
      listener: ((details: OnResponseStartedDetails) => void) | (null)
    ): void
    /**
