...
Calculate system idle time in seconds.
  ...
  interface Protocol {
    ...
    interceptHttpProtocol(
      scheme: string,
      handler: (request: Request, callback: (redirectRequest: RedirectRequest) => void) => void,
      completion?: (error: Error) => void
    ): void
    /**
...
The usage is the same with the `login` event of `app`.
     ...
     */
    on(event: "remote-get-builtin", listener: (event: IpcMainEvent, moduleName: string) => void): this
    once(event: "remote-get-builtin", listener: (event: IpcMainEvent, moduleName: string) => void): this
    addListener(event: "remote-get-builtin", listener: (event: IpcMainEvent, moduleName: string) => void): this
    removeListener(event: "remote-get-builtin", listener: (event: IpcMainEvent, moduleName: string) => void): this
    /**
     * Emitted when `remote.getCurrentWebContents()` is called in the renderer process.
     ...
     * value can be returned by setting `event.returnValue`.
     */
    on(event: "remote-get-global", listener: (event: IpcMainEvent, globalName: string) => void): this
    once(event: "remote-get-global", listener: (event: IpcMainEvent, globalName: string) => void): this
    addListener(event: "remote-get-global", listener: (event: IpcMainEvent, globalName: string) => void): this
    removeListener(event: "remote-get-global", listener: (event: IpcMainEvent, globalName: string) => void): this
    /**
    ...
    addListener(event: "remote-require", listener: (event: IpcMainEvent, moduleName: string) => void): this
    removeListener(event: "remote-require", listener: (event: IpcMainEvent, moduleName: string) => void): this
    /**
     * Emitted when the unresponsive web page becomes responsive again.
     */
    on(event: "responsive", listener: Function): this
...
Example usage:
    ...
    print(
      ...
      callback?: (success: boolean, failureReason: "cancelled" | "failed") => void
    ): void
    /**
