...
storiesOf("TransactionSummary", module)
  .add("Payment with memo", () => {
    ...
    const promise = (async () => {
      const account = await horizon.loadAccount(
        "GBPBFWVBADSESGADWEGC7SGTHE3535FWK4BS6UW3WMHX26PHGIH5NF4W"
      )
      ...
      builder.addOperation(
        Operation.payment({
          ...
          asset: Asset.native(),
          destination:
            "GA2CZKBI2C55WHALSTNPG54FOQCLC6Y4EIATZEIJOXWQPSEGN4CWAXFT"
        })
      )
